    ...
    <div className="fixed inset-0 z-50 flex items-center justify-end bg-slate-950/80 backdrop-blur-sm animate-fade-in">
      <div className="bg-slate-900 border-l border-slate-800 w-full max-w-2xl h-full flex flex-col shadow-2xl overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 scrollbar-thin">
          ...
          <div className="p-4 rounded-xl bg-gradient-to-r from-emerald-950/40 via-slate-900 to-teal-950/30 border border-emerald-500/30 flex items-start space-x-3">
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-bold text-slate-400 uppercase tracking-wider flex items-center space-x-1.5 border-b border-slate-800 pb-1.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
              ...
              <div className="bg-slate-950 p-3 rounded-xl border border-slate-800">
                <div className="flex items-center justify-between text-slate-400 mb-1 text-[11px]">
                  ...
                  >
                    {copiedField === 'nin' ? <Check className="h-3 w-3 text-emerald-400" /> : <Copy className="h-3 w-3" />}
                  </button>
                </div>
                <div className="font-mono text-sm font-bold text-emerald-400 tracking-wider">
                  {farmer.nin}
                </div>
                <span className="text-[10px] text-slate-500">11-digit text (zeros preserved)</span>
              </div>
              ...
              <div className="bg-slate-950 p-3 rounded-xl border border-slate-800">
                <div className="flex items-center justify-between text-slate-400 mb-1 text-[11px]">
                  ...
                  >
                    {copiedField === 'bvn' ? <Check className="h-3 w-3 text-teal-400" /> : <Copy className="h-3 w-3" />}
                  </button>
                </div>
                <div className="font-mono text-sm font-bold text-teal-300 tracking-wider">
                  {farmer.bvn}
                </div>
                <span className="text-[10px] text-slate-500">11-digit text (zeros preserved)</span>
              </div>
              ...
              {/* Phone */}
              <div className="bg-slate-950 p-3 rounded-xl border border-slate-800">
                <span className="text-[11px] text-slate-400 block mb-1">Primary Phone</span>
                <span className="font-mono text-slate-200">{farmer.phone_number || farmer.primary_phone || '—'}</span>
              </div>

              {/* Mother's Maiden Name */}
              <div className="bg-slate-950 p-3 rounded-xl border border-slate-800">
                <span className="text-[11px] text-slate-400 block mb-1">Mother's Maiden Name (Anti-Fraud)</span>
                <span className="text-slate-200">{farmer.mothers_maiden_name || 'Protected / Verified'}</span>
              </div>

              {/* Next of Kin */}
              <div className="bg-slate-950 p-3 rounded-xl border border-slate-800 sm:col-span-2">
                <span className="text-[11px] text-slate-400 block mb-1">Next of Kin / Alternate Contact</span>
                <span className="text-slate-200">{farmer.next_of_kin || 'Registered in Family File'}</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
              <div className="bg-slate-950 p-3 rounded-xl border border-slate-800">
                <span className="text-[11px] text-slate-400 block mb-1">State & LGA</span>
                <span className="font-bold text-white">{farmer.state || 'Benue'}, {farmer.lga}</span>
              </div>

              <div className="bg-slate-950 p-3 rounded-xl border border-slate-800">
                <span className="text-[11px] text-slate-400 block mb-1">Ward / Community</span>
                <span className="text-slate-200">{farmer.community_ward || farmer.ward || 'General Ward'}</span>
              </div>

              <div className="bg-slate-950 p-3 rounded-xl border border-slate-800 sm:col-span-2">
                <span className="text-[11px] text-slate-400 block mb-1">Cooperative Name</span>
                <span className="font-semibold text-emerald-300">{farmer.cooperative_name || 'Independent Producer'}</span>
              </div>

              <div className="bg-slate-950 p-3 rounded-xl border border-slate-800 sm:col-span-2">
                <span className="text-[11px] text-slate-400 block mb-1">GPS Coordinates & Landmark</span>
                ...
                {farmer.farm_location && (
                  <p className="text-[11px] text-slate-400 mt-1 italic">{farmer.farm_location}</p>
                )}
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
              <div className="bg-slate-950 p-3 rounded-xl border border-slate-800">
                <span className="text-[11px] text-slate-400 block mb-1">Primary Produce</span>
                <span className="font-bold text-white">{farmer.crop_type || farmer.value_chain_type || '—'}</span>
              </div>

              <div className="bg-slate-950 p-3 rounded-xl border border-slate-800">
                <span className="text-[11px] text-slate-400 block mb-1">Cultivated Land</span>
              ...
              <div className="bg-slate-950 p-3 rounded-xl border border-slate-800">
                <span className="text-[11px] text-slate-400 block mb-1">Estimated Yield</span>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-3 text-xs">
              ...
              <div className="bg-slate-950 p-3.5 rounded-xl border border-slate-800">
                <div className="flex items-center justify-between text-slate-400 mb-1.5 text-[11px]">
                  ...
                  <button
                    ...
                    className="text-slate-400 hover:text-cyan-400 flex items-center space-x-1 text-[10px]"
                  >
                    {copiedField === 'bio' ? (
                      <>
                ...
                <div className="font-mono text-xs text-cyan-300 break-all bg-slate-900/90 p-2.5 rounded-lg border border-slate-800/80">
                  {bioHash}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="bg-slate-950 p-3 rounded-xl border border-slate-800">
                  <span className="text-[11px] text-slate-400 block mb-1">Enumerator / Field Agent ID</span>
                  <span className="font-mono text-slate-200">{farmer.agent_id || 'System Ingest'}</span>
                </div>

                <div className="bg-slate-950 p-3 rounded-xl border border-slate-800">
                  <span className="text-[11px] text-slate-400 block mb-1">Device Hardware UUID</span>
                ...
                <div className="bg-slate-950 p-3 rounded-xl border border-slate-800">
                  <span className="text-[11px] text-slate-400 block mb-1">Captured At (UTC)</span>
                ...
                <div className="bg-slate-950 p-3 rounded-xl border border-slate-800">
                  <span className="text-[11px] text-slate-400 block mb-1">Server Ingestion Time</span>
                  <span className="font-mono text-slate-200">
